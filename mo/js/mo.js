$(function(){
  ...
  // small movie clip play
  $('#play01').click(function(){
    location.href="media/movieclip01.mp4";
  });
  $('#play02').click(function(){
    location.href="media/movieclip02.mp4";
  });
  $('#play03').click(function(){
    location.href="media/movieclip03.mp4";
  });
  $('#play04').click(function(){
    location.href="media/movieclip04.mp4";
  });
  $('#play05').click(function(){
    location.href="media/movieclip05.mp4";
  });
